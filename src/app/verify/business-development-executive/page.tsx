...
export const metadata: Metadata = {
  ...
  description:
    "Official verification page for the Business Development Executive of NF Nexa Tech. Verify employment status and credentials.",
  ...
  return (
    <main className="min-h-screen bg-slate-950 text-slate-100 relative overflow-hidden">
      <div className="pointer-events-none absolute inset-0 overflow-hidden">
        <div className="absolute -top-60 left-1/2 h-96 w-96 -translate-x-1/2 rounded-full bg-emerald-500/20 blur-3xl opacity-60" />
      ...
      <div className="relative mx-auto max-w-2xl px-4 py-12 sm:px-6 lg:px-8">
        ...
        <div className="relative overflow-hidden rounded-3xl border border-emerald-500/30 bg-slate-900/70 backdrop-blur-xl shadow-2xl">
          ...
          <div className="p-8 sm:p-10">
            <div className="mb-8 flex flex-col items-center gap-5 text-center sm:flex-row sm:text-left">
              <div className="relative shrink-0">
                ...
                <div className="relative flex h-20 w-20 items-center justify-center rounded-2xl border border-white/10 bg-slate-800 shadow-lg">
                  <Image src="/logo.png" alt="NF Nexa Tech" width={48} height={48} className="object-contain" priority />
                </div>
              ...
              <div>
                <div className="mb-1 inline-flex items-center gap-2 rounded-full border border-slate-700/60 bg-slate-800/60 px-3 py-1 text-xs font-mono text-slate-400">
                  NF-EMP-003 · Business Development
                </div>
                <h1 className="text-2xl font-bold text-white sm:text-3xl">Business Development Executive</h1>
                <p className="mt-1 bg-gradient-to-r from-emerald-500 to-teal-400 bg-clip-text text-sm font-semibold text-transparent">
            ...
            <div className="grid gap-4 sm:grid-cols-2">
              {[
                { label: "Designation", value: "Business Development Executive" },
                { label: "Company", value: "NF Nexa Tech" },
                { label: "Employee ID", value: "NF-EMP-003", mono: true },
                { label: "Department", value: "Business Development" },
                { label: "Member Since", value: "2023" },
                { label: "Official Email", value: "bde@nfnexatech.tech" },
              ].map((field) => (
            ...
            <div className="flex flex-col items-center gap-3 text-center">
              <div className="inline-flex items-center justify-center h-14 w-14 rounded-full border-2 border-emerald-500/30 bg-emerald-500/20 text-2xl shadow-lg">🛡️</div>
              ...
              <p className="font-mono text-[10px] text-slate-700">VERIFIED · NF-EMP-003 · nfnexatech.tech</p>
            </div>
          </div>
        </div>
