          ...
          <div className="p-8 sm:p-10">
            <div className="mb-8 flex flex-col items-center gap-5 text-center sm:flex-row sm:text-left">
              ...
              <div>
                <div className="mb-1 inline-flex items-center gap-2 rounded-full border border-slate-700/60 bg-slate-800/60 px-3 py-1 text-xs font-mono text-slate-400">
                  NFT-BDE-003 · Business Development
                </div>
                <h1 className="text-2xl font-bold text-white sm:text-3xl">Anzar</h1>
            ...
            <div className="grid gap-4 sm:grid-cols-2">
              ...
              <div className="rounded-xl border border-slate-700/50 bg-slate-800/40 p-4">
                ...
                <a href="mailto:bde@nfnexatech.tech" className="break-all text-sm font-semibold text-blue-400 hover:text-blue-300 transition-colors">
                  bde@nfnexatech.tech
                </a>
              </div>
            ...
            <div className="flex flex-col items-center gap-3 text-center">
              ...
              <p className="font-mono text-[10px] text-slate-700">VERIFIED · NFT-BDE-003 · nfnexatech.tech</p>
            </div>
          </div>
        </div>
